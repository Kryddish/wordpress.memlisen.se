...
<div class='about-section'>
	...
	<hr width="15%">
	<img src='wp-content/themes/learnwordpress/images/me.JPG'>
...
<div class="first-paralax">
	...
	<div class="services">
		<img class="camera-icon" src="wp-content/themes/learnwordpress/images/camera.png">
		<h1>Porträtt</h1>
	...
	<div class="services">
		...
		<img class="camera-icon" style="padding: 13%; padding-bottom: 2%;" src="wp-content/themes/learnwordpress/images/webbsite.png">
		<h1>Webbsidor</h1>
		<p>Jag är väldigt intresserad utav att fotografera och gör det mycket på fritiden. Om du kikar in i mitt galleri kan du hitta olika foton, även foton du kan köpa. </p>
	</div>

	<div class="services">
		<img class="camera-icon" src="wp-content/themes/learnwordpress/images/wordpress.png">
		<h1>Teman</h1>
		<p>Jag är väldigt intresserad utav att fotografera och gör det mycket på fritiden. Om du kikar in i mitt galleri kan du hitta olika foton, även foton du kan köpa. </p>
	</div>
